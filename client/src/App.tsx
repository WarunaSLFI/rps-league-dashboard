      ...
      <header className="sticky top-0 z-10 border-b border-white/5 bg-surface/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <h1 className="flex items-center gap-2 text-lg font-semibold tracking-tight text-white">
            <span className="text-xl">⚡</span> RPS League Dashboard
          </h1>
          <p className="hidden text-sm text-gray-400 sm:block">
            Live results powered by the Reaktor RPS API
          </p>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-3 xl:gap-12">
          ...
          <section className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="text-lg font-semibold text-white">Latest Matches</h3>
              <LatestMatches />
            </div>
